...
ggsave("Velocity/res/NC/paga_tree_cellcycle_adpted.pdf")
...
###prepare data====
##IR_2h
# IR_2h <- readRDS("scCANCER/res/IR_2h/IR_2h_seurat.rds")
...
IR_2h <- readRDS("scCANCER/res/int_scran_orig_cluster/IR_2h.rds")
